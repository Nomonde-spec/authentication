  ...
  return (
    <Card className="rounded-[28px] border border-white/10 bg-[#182235]/95 p-6 md:p-8 shadow-[0_35px_90px_-50px_rgba(0,0,0,0.65)]">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Badge className="rounded-full bg-slate-900/80 text-slate-300 w-fit">Live</Badge>
      </div>

      <div className="mt-6 space-y-4">
        {items.map((item) => (
          <div key={item.title} className="rounded-[24px] border border-white/10 bg-[#111827]/80 p-4 md:p-5 transition duration-300 hover:border-slate-600/40 hover:bg-[#111827]">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
              ...
              <ChevronRight size={18} className="text-slate-400 hidden sm:block flex-shrink-0" />
            </div>
            <div className="mt-3 sm:mt-4 flex flex-wrap items-center justify-between gap-2 text-sm text-slate-500">
